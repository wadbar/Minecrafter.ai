...
import { Terminal, Copy, Download, Zap, Play, Trash2, Save, FileCode, Bot, Cpu, Loader2 } from "lucide-react";
...
export default function ScriptHub() {
  ...
  const saveScript = (result: string, prompt: string) => {
    if (!result) return;
    ...
    toast.success("Script Arquivado", { description: "Injetado no cofre local do Sistema." });
  };
    ...
    <div className="flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="space-y-3 bg-neutral-900/50 p-3 rounded-xl border border-neutral-800/50">
            <div className="flex items-center justify-between">
              ...
              <div className="w-8 h-4 bg-emerald-500/20 rounded-full relative p-0.5">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="w-8 h-4 bg-neutral-800 rounded-full relative p-0.5" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="pt-4 border-t border-neutral-800/50">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-[10px] font-black uppercase tracking-widest text-neutral-300">Script_Archive</span>
        </div>
        ...
        <div className="flex items-center justify-between bg-neutral-900/50 px-4 py-2 rounded-xl border border-neutral-800/50">
          <div className="flex items-center gap-3">
             ...
             <span className="text-[10px] font-mono text-neutral-500 tracking-tighter">
               VIRTUAL_BUFFER: {Math.round(result.length / 1024 * 100) / 100} KB
             </span>
          </div>
